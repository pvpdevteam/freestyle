...
<head>
    ...
    {{HTML::style('public/css/plugins/morris.css');}}
...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="{{asset('admin/charts')}}"><i class="fa fa-fw fa-bar-chart-o"></i> Charts</a>
                    </li>
                    <li>
                        <a href="{{asset('admin/tables')}}"><i class="fa fa-fw fa-table"></i> Tables</a>
                    </li>
                    <li>
                        <a href="{{asset('admin/forms')}}"><i class="fa fa-fw fa-edit"></i> Forms</a>
                    </li>
                    <li>
                        <a href="{{asset('admin/bootstrap-elements')}}"><i class="fa fa-fw fa-desktop"></i> Bootstrap Elements</a>
                    </li>
                    <li>
                        <a href="{{asset('admin/bootstrap-grid')}}"><i class="fa fa-fw fa-wrench"></i> Bootstrap Grid</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{asset('admin/blank-page')}}"><i class="fa fa-fw fa-file"></i> Blank Page</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    {{HTML::script('public/js/jquery-1.11.0.js');}}
    ...
    {{HTML::script('public/js/plugins/flot/jquery.flot.js');}}
    {{HTML::script('public/js/plugins/flot/jquery.flot.tooltip.min.js');}}
    {{HTML::script('public/js/plugins/flot/jquery.flot.resize.js');}}
    {{HTML::script('public/js/plugins/flot/jquery.flot.pie.js');}}
    {{HTML::script('public/js/plugins/flot/flot-data.js');}}
